...
class CountStepsSpec extends AnyFlatSpec with Matchers {
  ...
  it should "be able to count steps east north" in {
    val input = List(
      List('S', '.'),
      List('|', 'S'),
      List('L', 'J')
  ...
  it should "be able to count steps east south" in {
    val input = List(
      List('S', '-', '7'),
      List('L', '7', '|'),
      List('.', 'L', 'J')
  ...
  it should "be able to count steps west south" in {
    val input = List(
      List('.', 'S', '7'),
      List('F', 'J', '|'),
      List('L', '-', 'J')
  ...
  it should "solve the example" in {
    ...
    CountSteps.solve(input) shouldBe 16
  }
